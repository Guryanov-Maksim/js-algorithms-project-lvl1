...
const doc1 = { id: 'doc1', text: "I can't SHooTs 2 straight unless I've had a pint!" };
...
const expectedResults = ['doc2', 'doc4', 'doc5', 'doc1'];
const expectedResults2 = ['doc1'];
const expectedResults3 = ['doc4', 'doc2', 'doc5', 'doc1'];
